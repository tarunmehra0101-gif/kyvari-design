...
export const trips = [
  { title: "Bhutanese Bliss: A Himalayan Adventure for Two", short: 'Bhutanese Bliss', city: 'Paro', dates: '20–22 Jul', client: 'Meera & Arjun', rating: '4.8', tag: tag.adventure, sc: scenes.paro, detail: true },
  { image: 'https://images.unsplash.com/photo-1555921015-5532091f6026?w=600&h=400&fit=crop', title: "Hanoi's Romantic Charms: A Couple's Escape", short: "Hanoi's Romantic Charms", city: 'Hanoi', dates: '20–22 Jul', client: 'The Kapoors', rating: '4.7', tag: tag.romantic, sc: scenes.hanoi },
  { image: 'https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=600&h=400&fit=crop', title: 'Bangkok Bazaar: A Luxury Shopping Spree', short: 'Bangkok Bazaar', city: 'Bangkok', dates: '20–21 Jul', client: 'Ritu S.', rating: '4.6', tag: tag.urban, sc: scenes.bangkok },
  { image: 'https://images.unsplash.com/photo-1512100356356-de1b84283e18?w=600&h=400&fit=crop', title: 'Azure Escapes: A Lakshadweep Luxury Retreat', short: 'Azure Escapes', city: 'Lakshadweep', dates: '24–28 Jul', client: 'Honeymoon', rating: '4.9', tag: tag.luxury, sc: scenes.laksha },
  { image: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=600&h=400&fit=crop', title: 'Kuala Lumpur Skyline & Street Food Sprint', short: 'KL Skyline Sprint', city: 'Kuala Lumpur', dates: '1–3 Aug', client: 'Solo · Dev', rating: '4.5', tag: tag.urban, sc: scenes.kl },
  { image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&h=400&fit=crop', title: 'Dubai Desert Lights: Dunes to Downtown', short: 'Dubai Desert Lights', city: 'Dubai', dates: '8–11 Aug', client: 'Family · 4', rating: '4.7', tag: tag.adventure, sc: scenes.dubai }
];
