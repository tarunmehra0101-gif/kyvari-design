...
/* ─── Data ─── */
const kpis = [
  { label: 'Itineraries Sent', value: '38', change: '+15%', up: true, color: '#8b5cf6' },
  { label: 'Client View Rate', value: '84%', change: '+4%', up: false, color: '#f97316' },
  { label: 'Avg. Dwell Time', value: '5m 42s', change: '+8%', up: true, color: '#0ea5e9' },
  { label: 'Booking Rate', value: '32%', change: '+6%', up: true, color: '#22c55e' },
];
      ...
      <div className="ky-analytics-page">
        ...
        <main style={{ flex: 1, marginLeft: sidebarCollapsed ? "72px" : "260px", transition: "margin 0.3s", padding: "32px", background: "#f8f8fa", minHeight: "100vh" }}>
          ...
          <div className="ky-kpi-grid">
            {kpis.map((kpi, i) => (
              <div key={i} className="ky-kpi-card" style={{ animation: `fadeUp 0.4s ease-out ${i * 0.1}s both` }}>
                <div style={{ fontSize: "13px", color: "#71717a", marginBottom: "12px" }}>{kpi.label}</div>
                <div style={{ fontSize: "32px", fontWeight: 800, marginBottom: "8px", color: kpi.color }}>{kpi.value}</div>
                <span style={{
          ...
          <div className="ky-grid-2">
            ...
            <div className="ky-card">
              ...
              <div className="ky-legend">
                <div className="ky-legend-item"><span className="ky-legend-dot" style={{ background: '#a4d673' }}></span>Views</div>
                <div className="ky-legend-item"><span className="ky-legend-dot" style={{ background: '#608c35' }}></span>Peak Sessions</div>
              </div>
              <div className="ky-bar-chart">
                {weeklyData.map((d, i) => (
                  <div key={i} className="ky-bar-group">
                    <div className="ky-bar-stack">
                      <div className="ky-bar" style={{ height: `${d.views * 2.5}px`, background: i === 4 ? '#608c35' : '#a4d673' }}></div>
                      <div className="ky-bar" style={{ height: `${d.sessions * 2.5}px`, background: i === 4 ? '#4a6d29' : '#88c54c' }}></div>
                    </div>
          ...
          <div className="ky-grid-2">
            ...
            {/* Top Itineraries */}
            <div className="ky-card">
              <h2 className="ky-card-title">Top Itineraries</h2>
              ...
              <table className="ky-table">
                ...
                <tbody>
                  {topItineraries.map((item, i) => (
                    <tr key={i}>
                      <td>
                        <div className="ky-title-cell">{item.title}</div>
                        <div style={{ color: '#71717a', fontSize: '12px' }}>{item.client}</div>
                      </td>
                      <td>{item.views}</td>
                      <td>
