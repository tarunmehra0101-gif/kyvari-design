    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ky-btn-coral { background: linear-gradient(135deg, #ff8a5c, #e8543f); color: #fff; box-shadow: 0 4px 12px rgba(232,84,63,0.3); }
              ...
              <Link href="/detail2" key={i} className="ky-trip-card" style={{ animation: `fadeUp 0.4s ease-out ${i * 0.08}s both` }}>
                <div className="ky-trip-img">
                  ...
                  <div className="ky-trip-top">
                    <span className="ky-trip-tag" style={{ background: tagColors[trip.tag]?.bg || '#71717a', color: '#fff' }}>
                      {trip.tag}
                    </span>
