  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-12">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-display-lg text-ink">Itineraries</h1>
        ...
        <div className="flex w-full items-center gap-2 sm:w-auto">
          <label className="relative flex-1 sm:w-72">
            ...
            <input
              ...
              className="h-11 w-full rounded-full border border-line bg-surface pl-11 pr-4 text-sm text-ink shadow-soft outline-none transition-colors placeholder:text-ink-mute focus:border-lagoon-300"
            />
          </label>
          <button
            type="button"
            aria-label="Filter"
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-line bg-surface text-ink-soft shadow-soft transition-colors hover:border-lagoon-300 hover:text-lagoon-700"
          >
